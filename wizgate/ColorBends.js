...
export function initColorBends(container, options = {}) {
    ...
    const uColorsArray = Array.from({ length: MAX_COLORS }, (_, i) => {
        if (i < colors.length) return toVec3(colors[i]);
    ...
    const material = new THREE.ShaderMaterial({
        ...
        fragmentShader: frag,
        uniforms: {
            uCanvas: { value: new THREE.Vector2(container.clientWidth || 100, container.clientHeight || 100) },
            uTime: { value: 0 },
            uSpeed: { value: speed },
